...
__decorate([
    (0, typeorm_1.ManyToOne)(() => song_request_entity_1.SongRequest, (r) => r.votes, { eager: false }),
    __metadata("design:type", song_request_entity_1.SongRequest)
], Vote.prototype, "songRequest", void 0);
__decorate([
...
], Vote.prototype, "room", void 0);
exports.Vote = Vote = __decorate([
    (0, typeorm_1.Entity)('votes'),
    (0, typeorm_1.Unique)(['songRequest', 'user'])
], Vote);
